Feature: As a user I want to be able to navigate through the CVEs predefined from the explorer module filter while inside a CVE's details
    Scenario: A user logs into the app and tries to navigate with the buttons
